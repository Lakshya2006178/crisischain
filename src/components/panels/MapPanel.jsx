...
export default function MapPanel() {
    ...
    return (
        <div className="flex flex-col h-full w-full bg-[#0A0A0B]/20 relative overflow-hidden  group">
            ...
            {/* Header HUD */}
            <div className="flex items-center justify-between px-6 py-5 border-b border-[#1F2937] bg-white/[0.02] relative">
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        <h4 className="font-poppins font-black text-xl tracking-tight text-white uppercase leading-none mb-1">GEOSPATIAL_INTEL</h4>
                ...
                <div className="flex gap-4">
                    <button
                        ...
                        className="w-10 h-10 border border-[#374151] flex items-center justify-center text-[#9CA3AF] hover:text-white hover:bg-[#1F2937] transition-all"
                    >
            ...
            {/* Map Body */}
            <div className="flex-1 relative overflow-hidden bg-black/40 border-b border-[#1F2937]">
                ...
                {markers.map(marker => (
                    ...
                    >
                        <div className="relative flex items-center justify-center">
                            ...
                            {/* Marker Metadata HUD */}
                            <div className="absolute top-8 left-1/2 -translate-x-1/2 px-4 py-2 bg-black/80  border border-[#374151] opacity-0 group-hover/marker:opacity-100 transition-all duration-500 whitespace-nowrap z-20 pointer-events-none">
                                ...
                                <div className="font-mono text-[8px] text-[#9CA3AF] tracking-[0.2em]">LAT_SYNC: {marker.top} | LNG_SYNC: {marker.left}</div>
                            </div>
                        </div>
                    </div>
                ))}
                ...
                {/* Legend HUD */}
                <div className="absolute bottom-10 right-10 flex flex-col gap-4 p-8 bg-black/60  border border-[#1F2937] opacity-40 hover:opacity-100 transition-opacity">
                    {[
            ...
            <div className="px-6 py-4 bg-black flex justify-between items-center bg-white/[0.02]">
                <div className="flex gap-10">
                    <div className="flex items-center gap-3">
                         ...
                         <span className="font-mono text-[9px] text-[#9CA3AF] tracking-widest uppercase italic">COORD_SYS: WGS84_OPTIMIZED</span>
                    </div>
                    <div className="flex items-center gap-3">
                         <Zap className="w-3.5 h-3.5 text-yellow-500/40" />
                         <span className="font-mono text-[9px] text-[#9CA3AF] tracking-widest uppercase italic">SIGNAL: 44.2dBm</span>
                    </div>
                </div>
            </div>
